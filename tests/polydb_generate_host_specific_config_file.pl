...
=head1 SYNOPSIS
polydb_generate_host_specific_config_file.pl [--file_prefix <output file prefix> ] [--help ]


=head1 DESCRIPTION

This script attempts to either guess host specific properties or request from the user the respective information.  
It saves the gathered information in the file <prefix given as parameter>.polydb.host_specific.conf.
